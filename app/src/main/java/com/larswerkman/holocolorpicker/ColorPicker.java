...
import com.example.danil.skilder.R;
...
//		else {
        // Draw the new selected color in the center.
        mCenterNewPaint.setStyle(Paint.Style.STROKE);
//        mCenterNewPaint.setStrokeWidth(6);
        canvas.drawArc(mCenterRectangle, 0, 360, true, mCenterNewPaint);
//		}
    }

    public float getBrushWidth() {
        return mCenterNewPaint.getStrokeWidth();
    }

    public void setBrushWidth(float width){
        mCenterNewPaint.setStrokeWidth(width);
        invalidate();
    }
